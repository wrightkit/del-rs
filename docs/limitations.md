...
- Parameter storage, player-context locals, parameterized calls,
  recursive/re-entrant storage, member storage, and return-value ABI remain
  structured `HI018` gaps; the adapter does not change HIR or canonical WIR.
